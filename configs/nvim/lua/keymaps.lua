...
vim.api.nvim_set_keymap("n", "<leader>cic", "<cmd>lua require('telescope.builtin').lsp_incoming_calls()<CR>", options)
vim.api.nvim_set_keymap("n", "<leader>coc", "<cmd>lua require('telescope.builtin').lsp_outgoing_calls()<CR>", options)
vim.api.nvim_set_keymap("n", "<leader>cws", "<cmd>lua require('telescope.builtin').lsp_workspace_symbols()<CR>", options)
vim.api.nvim_set_keymap("n", "<leader>cdws", "<cmd>lua require('telescope.builtin').lsp_dynamic_workspace_symbols()<CR>", options)
vim.api.nvim_set_keymap("n", "<leader>cis", "<cmd>lua require('telescope.builtin').lsp_document_symbols()<CR>", options)
vim.api.nvim_set_keymap("n", "<leader>ce", "<cmd>lua require('telescope.builtin').diagnostics()<CR>", options)
vim.api.nvim_set_keymap("n", "<leader>cgd", "<cmd>lua require('telescope.builtin').lsp_definitions()<CR>", options)
vim.api.nvim_set_keymap("n", "<leader>cgr", "<cmd>lua require('telescope.builtin').lsp_references()<CR>", options)
vim.api.nvim_set_keymap("n", "<leader>cgt", "<cmd>lua require('telescope.builtin').lsp_type_definitions()<CR>", options)
vim.api.nvim_set_keymap("n", "<leader>cgi", "<cmd>lua require('telescope.builtin').lsp_implementations()<CR>", options)
vim.api.nvim_set_keymap("n", "<leader>ch", "<cmd>lua vim.lsp.buf.hover()<CR>", options)
vim.api.nvim_set_keymap("n", "<leader>crn", "<cmd>lua vim.lsp.buf.rename()<CR>", options)

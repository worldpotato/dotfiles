...
hi({ group = "Folded", gui = "NONE", guifg = wp08, guibg = wp03 })
hi({ group = "FoldColumn", gui = "NONE", guifg = wp06, guibg = wp00 })
...
-- hi({ group = "@macro", guifg = wp07, guibg = wp00 })
...
-- semantic tokens
-- hi({ group = "@lsp.type.function", guifg = wp00, guibg = wp02 })

-- Semantic Tokens types
hi({ group = "@keyword", guifg = wp06 })
hi({ group = "@function", guifg = wp11 })
hi({ group = "@method", guifg = wp03 })
hi({ group = "@variable", guifg = wp15 })
hi({ group = "@namespace", guifg = wp07 })
hi({ group = "@comment", guifg = wp06 })
hi({ group = "@macro", guifg = wp05 })
hi({ group = "@builtinAttribute", guifg = wp02 })
hi({ group = "@attributeBracket", guifg = wp10 })
hi({ group = "@enumMember", guifg = wp09 })
hi({ group = "@operator", guifg = wp15 })
hi({ group = "@string", guifg = wp14 })
hi({ group = "@enum", gui = "bold", guifg = wp04 })
hi({ group = "@property", guifg = wp03 })
hi({ group = "@formatSpecifier", guifg = wp04 })
hi({ group = "@number", guifg = wp04 })
hi({ group = "@struct", guifg = wp12 })
hi({ group = "@decorator", guifg = wp02 })
hi({ group = "@derive", guifg = wp10 })

-- modifier
hi({ group = "@library", gui = "italic" })
hi({ group = "@public", gui = "underline" })
hi({ group = "@consuming", gui = "bold" })

hi({ group = "@declaration", gui = "bold" })
hi({ group = "@attribute", gui = "bold" })

-- Rust
hi({ group = "RustHints", gui = "italic", guifg = wp07, guibg = "NONE" })
link("rustModPath", "@namespace")
link("rustAttribute", "@builtinAttribute")
link("rustKeyword", "@keyword")
link("rustIdentifier", "@namespace")
link("rustComment", "@comment")
link("rustFuncName", "@namespace")
link("rustFuncCall", "@function")
link("rustMacro", "@macro")
link("rustString", "@string")
link("rustEnumVariant", "@enumMember")
link("rustEnum", "@enum")
link("rustFoldBraces", "@property")
link("rustSigil", "@namespace")
link("rustOperator", "@operator")
link("rustModPathSep", "@operator")
